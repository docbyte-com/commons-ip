...
public final class Utils {
    ...
    public static void deletePath(Path path) throws IOException {
        ...
        try {
            ...
            /*
             * In certain cases, temporary files may remain locked and cannot be deleted,
             * leading to a DirectoryNotEmptyException. Ignore the exception.
             * Leftover temporary files will eventually be cleaned up by the Janitor service.
             */
